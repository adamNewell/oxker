...
// TODO: Remove terminal dependencies for UI independence
// This module needs significant refactoring to work through command/response pattern
// Terminal handling should be moved to UI layer
