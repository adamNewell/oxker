...
use oxker_core::{
    AppColors, ByteStats, ContainerItem, ContainerId, CpuStats,
...
fn main() {
    ...
    
    {
        ...
        // Add logs
        for i in 0..1000 {
            state.logs.push_back(format!("Log line {} with some content that might be quite long", i));
        }
    }
    ...
    for i in 0..100 {
        ...
        let _view_model = FrameViewModel::from_state(
            &*ui_state_lock,
            &*gui_state_lock,
            colors,
            200,
