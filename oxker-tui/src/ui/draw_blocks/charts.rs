    ...
    if let Some(chart_data) = fd.chart_data.as_ref() {
        ...
        let cpu_dataset = vec![
            Dataset::default()
                ...
                .style(Style::default().fg(ratatui::style::Color::from(colors.chart_cpu.points)))
        ...
        let mem_dataset = vec![
            Dataset::default()
                .marker(symbols::Marker::Dot)
                .style(Style::default().fg(ratatui::style::Color::from(colors.chart_memory.points)))
                .graph_type(GraphType::Line)
                .data(&mem.0),
        ];
...
mod tests {
    ...
    fn test_draw_blocks_charts_custom_colors() {
        ...
        colors.chart_cpu.background = ratatui::style::Color::White;
        colors.chart_cpu.border = ratatui::style::Color::Red;
        colors.chart_cpu.title = ratatui::style::Color::Green;
        colors.chart_cpu.max = ratatui::style::Color::Magenta;
        colors.chart_cpu.points = ratatui::style::Color::Black;
        colors.chart_cpu.y_axis = ratatui::style::Color::Blue;

        colors.chart_memory.background = ratatui::style::Color::White;
        colors.chart_memory.border = ratatui::style::Color::Red;
        colors.chart_memory.title = ratatui::style::Color::Green;
        colors.chart_memory.max = ratatui::style::Color::Magenta;
        colors.chart_memory.points = ratatui::style::Color::Black;
        colors.chart_memory.y_axis = ratatui::style::Color::Blue;
