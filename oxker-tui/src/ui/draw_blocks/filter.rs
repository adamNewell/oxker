...
mod tests {
    ...
    fn test_draw_blocks_filter_row_custom_colors() {
        ...
        colors.filter.highlight = ratatui::style::Color::Blue;
        colors.filter.selected_filter_background = ratatui::style::Color::Red;
        colors.filter.selected_filter_text = ratatui::style::Color::Yellow;
        colors.filter.text = ratatui::style::Color::Magenta;
